...
public:
    Dataset();
    static std::pair<std::vector<std::vector<double> >, std::vector<int>> load(std::string filename, const std::string &directory = ".", size_t max_lines = SIZE_MAX);
...
private:
    static void process_line(std::vector<std::vector<double>> &X, std::vector<int> &y,
